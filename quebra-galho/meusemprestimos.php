<?php
    ...
    $sql = "SELECT * FROM itens WHERE responsavel = '$responsavel'";
                    ...
                    <table class="table">
                        ...
                        <?php
                            while($user_data = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='col col8'>
                                        <a href='edit-item.php?$user_data[id_item]'>
                                        <i class='fas fa-edit'></i>
                                        </a>
                                        <a href='delete-item.php?$user_data[id_item]'>
